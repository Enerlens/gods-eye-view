...
| 🧸 **Accueil du jeune enfant** 🇫🇷 | Où l'on trouve une place, et où l'on n'en trouve pas. **Il n'existe aucun registre national ouvert des crèches** — la Cnaf publie 210 jeux de données et pas un seul établissement, FINESS n'en contient que 183 par accident, le BPE de l'INSEE s'arrête à 2021 côté API, et filtrer Sirene sur le code NAF de l'entreprise fait disparaître **tout le secteur public**. Cette couche dessine donc l'indicateur que l'État publie vraiment : les **places pour 100 enfants de moins de 3 ans**, aux trois échelles de la Cnaf — 96 départements en aplat, puis 1 250 intercommunalités et 1 061 communes en points. La couleur est un **rapport à la moyenne nationale** (60,9), pas un quantile, pour qu'elle veuille dire la même chose à tous les zooms. Chaque fiche donne les cinq modes qui composent le taux et lequel domine : la Vendée est à 85,7 mais par l'assistante maternelle, pas par la crèche. Les 6 territoires ultramarins que les polygones métropolitains ne peuvent pas peindre sont **tous sous la moyenne** — la Guyane à 22 % de la moyenne française — et sont comptés sur la fiche nationale plutôt que perdus | Cnaf · geo.api.gouv.fr | 🟢 |
