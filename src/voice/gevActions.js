...
const LAYER_ALIASES = new Map([
  ...
  ["frequency", 'idfm-frequency'],
  ["transit frequency", 'idfm-frequency'],
  ["service frequency", 'idfm-frequency'],
  ["departures", 'idfm-frequency'],
  ["departures per hour", 'idfm-frequency'],
  ["how often", 'idfm-frequency'],
  ["headway", 'idfm-frequency'],
  ["frequence", 'idfm-frequency'],
  ["fréquence", 'idfm-frequency'],
  ["frequence des transports", 'idfm-frequency'],
  ["fréquence des transports", 'idfm-frequency'],
  ["frequences", 'idfm-frequency'],
  ["fréquences", 'idfm-frequency'],
  ["offre horaire", 'idfm-frequency'],
  ["offre de transport", 'idfm-frequency'],
  ["passages", 'idfm-frequency'],
  ["passages par heure", 'idfm-frequency'],
  ["courses", 'idfm-frequency'],
  ["desserte", 'idfm-frequency'],
  ["idfm frequence", 'idfm-frequency'],
  ["idfm fréquence", 'idfm-frequency'],
  ["noise", 'bruit-fr'],
  ["noise zone", 'bruit-fr'],
